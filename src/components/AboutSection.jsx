...
export default function AboutSection() {
  return (
    <section id="about" className="section bg-transparent border-t border-white/[0.08] px-3 sm:px-4">
      <div className="container">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-10 items-start">
          ...
          <div className="lg:col-span-8">
            <h2 className="font-display font-semibold text-2xl sm:text-4xl md:text-5xl leading-tight tracking-tight text-white mb-5 sm:mb-6 text-glow">
            ...
            <div className="space-y-3 sm:space-y-4 max-w-xl text-sm sm:text-lg font-light text-white/65 leading-relaxed">
              <p>
            ...
            <div className="mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-white/[0.08] flex items-start sm:items-center gap-3 text-xs font-mono text-white/50">
              <span className="w-1.5 h-1.5 rounded-full bg-[#00D6FF] shadow-[0_0_8px_#00D6FF] flex-shrink-0 mt-1 sm:mt-0" />
