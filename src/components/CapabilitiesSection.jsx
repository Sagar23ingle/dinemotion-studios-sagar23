          ...
          {capabilities.map((cap, index) => {
            ...
            return (
              <div
                ...
                className={`group py-4 sm:py-6 flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-4 transition-all duration-200 cursor-pointer ${
              ...
              >
                <div className="flex items-baseline gap-3 sm:gap-8">
                  ...
                  <h3 className="font-display text-lg sm:text-3xl md:text-4xl font-semibold tracking-tight text-white group-hover:text-[#00D6FF] transition-colors duration-200 break-words">
                    {cap.name}
                  </h3>
                </div>

                <div className="mt-1 sm:mt-0 flex items-center justify-between sm:justify-end gap-3 sm:gap-5">
                  <span className="text-[11px] sm:text-xs font-mono text-white/50 tracking-wider uppercase">
                    {cap.category}
                  </span>
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-white/10 flex items-center justify-center text-white/40 group-hover:text-white group-hover:border-[#00D6FF] group-hover:bg-[#0050FF]/15 transition-all duration-200">
